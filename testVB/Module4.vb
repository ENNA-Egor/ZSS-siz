...
CounterRow = ThisWorkbook.Worksheets("Ëèñò2").Range("B3:B14").Rows.Count
MsgBox CounterRow
...
Dim listobjMagazineList As ListObject
      ...
      Set listobjTables = ThisWorkbook.Worksheets("Data").ListObjects("RequisitesTables") 'Íàèìåíîâàíèå ïîäïàïêè
                            For Each rgCellChecked In listobjTables.ListColumns("Ïð.").DataBodyRange
                                    If rgCellChecked.Value = UserForm1.ComboBox1.Value Then
                                     firm = Intersect(rgCellChecked.EntireRow, listobjTables.ListColumns("Ïð. ìèí").DataBodyRange)
...
'////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    'Íà÷àëî âíåñåíèÿ çíà÷åíèé â Data Table
 'Çàïèñü öåëüíûõ çíà÷åíèé
                ...
                ThisWorkbook.Worksheets("Ëèñò1").Range("O1").Value = NumOf & "-" & DataCreat
                'ThisWorkbook.Worksheets("Ëèñò1").Range("O1") = Format(Now, "yyyy.mm")
'///////////////////////////////////////////////////////////////////////////////////////////////////////
